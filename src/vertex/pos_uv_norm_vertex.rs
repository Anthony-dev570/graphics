...
impl Vertex for PositionUvNormalVertex {
    fn load_attrib_pointers() {
        unsafe {
            let stride = (size_of::<Vector3F32>() + size_of::<Vector2F32>() + size_of::<Vector3F32>()) as i32;
            ...
            gl::VertexAttribPointer(2, 3, gl::FLOAT, gl::FALSE, stride, (size_of::<Vector3F32>() + size_of::<Vector2F32>()) as *const _);
